...
| GitHub CI account billing gate                                          | Open           | `main` run `31019541395` fails before runner steps and provides no logs; repair account billing before treating CI as green.                               |
