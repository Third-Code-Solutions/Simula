...
| GitHub CI account billing gate                                          | Open           | PR `#8` run `31028630814` fails before runner steps and provides no logs; repair account billing before treating CI as green.                              |
