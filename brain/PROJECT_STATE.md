...
- M6 / P2-07 is reopened. Its prior self-audit gate remains valid historical evidence (E-5022), but the independent review failed (E-5023). Expired-lease/stale-attempt authority (E-5024), fail-closed result persistence (E-5025), worker retry/deadline/heartbeat/telemetry drift (E-5026), deterministic worker no-egress enforcement (E-5027), and SBOM/container scanning (E-5028) are remediated; all remaining Critical/High findings must be cleared before re-review.
