...
Obtain a human keyboard/screen-reader smoke and establish enforceable required-check governance before Phase 3. Govern user-facing deletion and full application-compatible restore before making broader retention/recovery claims. No real-provider egress or representativeness claim is authorized.
