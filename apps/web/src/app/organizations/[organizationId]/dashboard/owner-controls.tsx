    ...
    <section className={styles.ownerArea} aria-labelledby="owner-controls">
      <div className={styles.ownerHeading}>
        <div>
          ...
          <p>
            Team access, feature gates, audit evidence, and permanent workspace
            deletion. Every command is authorized again by the API and database.
          </p>
        </div>
          ...
          <article className={styles.adminPanel} aria-labelledby="flags-title">
            <header>
              ...
              <div>
                ...
                <p>
                  Change controlled workspace behavior with an audit reason.
                </p>
              </div>
            </header>
        ...
        >
          <header>
            <span className={styles.panelNumber}>
              {organizationStatus === "active" ? "04" : "01"}
            </span>
            <div>
              <h3 id="deletion-title">
                {organizationStatus === "active"
                  ? "Delete workspace"
                  : "Complete pending deletion"}
              </h3>
              <p>
                {organizationStatus === "active"
                  ? "Permanently purge this workspace after all runs are terminal."
                  : "External cleanup did not finish. Retry the durable purge."}
              </p>
            </div>
          </header>
          <div className={styles.deletionWarning}>
            ...
            <p>
              Projects, stimuli, assets, runs, reports, team access, and audit
              records will be removed. This action cannot be undone.
            </p>
          </div>
          <form className="form-stack" onSubmit={onDelete}>
