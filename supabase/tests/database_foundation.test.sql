...
select extensions.is(
  ...
  array[
    ...
    'campaign_lab_artifacts_worker_delete',
    'campaign_lab_artifacts_worker_select',
    ...
    'campaign_lab_runs_command_update',
    'campaign_lab_runs_worker_delete',
...
select extensions.is(
  ...
  array[
    ...
    'simula_worker_owner|api.campaign_lab_artifacts|DELETE',
    'simula_worker_owner|api.campaign_lab_events|INSERT',
    'simula_worker_owner|api.campaign_lab_runs|DELETE',
